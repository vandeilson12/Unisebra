                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="modalidade" name="modalidade" placeholder="Modalidade" class="form-control">
                                                </div>
                                            </div>

                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectLg" class=" form-control-label">CH</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="ch" name="ch" placeholder="CH" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="publico_alvo" id="publico_alvo" rows="9" placeholder="Publico Alvo ..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="row form-group">
                                                <div class="col col-md-3">
