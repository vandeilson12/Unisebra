                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" class="form-horizontal" action="{{url("/cursos/update/modulo/$cursomodulos->id")}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Modulo</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="modulo" name="modulo" value="{{ $cursomodulos->modulo }}" placeholder="Modulo" class="form-control">
                                                </div>
