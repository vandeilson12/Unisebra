                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    @php
                                                    $cc = $cursodescricao->find($cursodescricao->id)->cursos;
                                        ...
                                        <a href="{{ url("/cursos/finalizar/descricao/$cursodescricao->id")}}" class="btn btn-danger btn-sm">
