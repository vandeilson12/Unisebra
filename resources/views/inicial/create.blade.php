                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" class="form-horizontal" action="{{url("/cursos/store")}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="cod_curso" class=" form-control-label">Código do Curso</label>
                                                </div>
                                                @php 
                                                    $end = md5(time());
                                                @endphp
                                                <div class="col-12 col-md-9">
                                                    <input disabled="" type="text" id="cod_curso" name="cod_curso" value="{{$end}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectLg" class=" form-control-label">Categoria</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="selectLg" class=" form-control-label">SubCategoria</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="subcategoria" name="subcategoria" placeholder="Subcategoria" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="cursos" name="cursos" placeholder="Cursos" class="form-control">
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="descricao" id="descricao" rows="9" placeholder="Descrição ..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="detalhes" id="detalhes" rows="9" placeholder="Detalhes ..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <!-- <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Preço</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="preco_total" name="preco_total" placeholder="Preço" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="preco_parcelas" name="preco_parcelas" placeholder="Parcelas em valor" class="form-control">
                                                </div>
                                            </div>
