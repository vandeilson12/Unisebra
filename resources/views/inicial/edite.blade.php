                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form method="post" class="form-horizontal" action="{{url("/inicial-editar-carrosel/mais")}}" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <div class="card">
                                    <div class="card-header">
                                        <strong>Carrosel</strong> 
                        ...
                        @foreach($carrosel as $c)
                            ...
                            <div class="card-body card-block">
                                            ...
                                            <a href="{{ url("/inicial-editar-carrosel/editar/$c->id}")}}" class="btn text-light ml-3 float-right btn-info btn-sm">
                                                <i class="fa fa-dot-circle-o"></i> Editar
                                            </a>


                                            <a href="{{ url("/inicial-editar-carrosel/deletar/$c->id}")}}" class="btn text-light ml-3  float-right btn-danger btn-sm">
