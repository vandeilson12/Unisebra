                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" class="form-horizontal" action="{{url("/inicial-editar-motivacao/update/$motivacao->id")}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="titulo" name="titulo" value="{{ $motivacao->titulo }}" placeholder="Titulo" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                            <textarea rows="9" id="content" name="content" class="form-control">{{ $motivacao->content }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="file" value="{{ $motivacao->img}}" id="img" name="img" class="form-control-file">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="file" id="video" value="{{ $motivacao->video}}" name="video" class="form-control-file">
                                        </div>
                                    </div>
