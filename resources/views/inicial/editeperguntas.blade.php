                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" class="form-horizontal" action="{{url("/inicial-editar-preguntas/update/$perguntas->id")}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="titulo" name="titulo" value="{{ $pergunta->titulo }}" placeholder="Titulo" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea rows="9" id="content" name="content" class="form-control">{{ $pergunta->content }}</textarea>
                                            </div>
                                        </div>
